            ...
            <div className="row">
              <div className="col-xl-4 col-lg-4 col-md-7 col-sm-8">
                <div className="bottom-logo">
                  <img className="pb-3" src={logoh} alt="" />
                  <p>
                    Digital Eden is a unique and beautiful collection of UI
                    elements that are all flexible and modular. A complete and
              ...
              <div className="col-xl-2 col-lg-2 col-md-8 col-sm-8">
                <div className="bottom-widget">
                  <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-5 col-sm-6 col-6">
                      <ul></ul>
                    </div>
                  </div>
                </div>
